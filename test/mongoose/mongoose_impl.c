...
struct attribute s_settings_attributes[] = {
  ...
  {"gps_sync", "string", NULL, offsetof(struct settings, gps_sync), 12, false},
...
struct attribute s_ins_cfg_attributes[] = {
  ...
  {"insInstAng", "double", NULL, offsetof(struct ins_cfg, insInstAng), 0, false},
  ...
  {"insInitAziAzimuth", "double", NULL, offsetof(struct ins_cfg, insInitAziAzimuth), 0, false},
  {"insInitAziStdAzi", "double", NULL, offsetof(struct ins_cfg, insInitAziStdAzi), 0, false},
